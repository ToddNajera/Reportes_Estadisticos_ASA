...
/*Consulta por mes en poliza*/$query_POLIZA='SELECT * FROM poliza WHERE tipo="Ig" AND MONTH(fecha) BETWEEN "'.$fechaIN_Consulta[1].'" AND "'.$fechaFN_Consulta[1].'" AND YEAR(fecha)="'.$year_Consulta.'"';
/*Consulta por mes en cuentas_gastos*/$query_CTAGASTOS='SELECT * FROM cuentas_gastos WHERE MONTH(fecha) BETWEEN "'.$fechaIN_Consulta[1].'" AND "'.$fechaFN_Consulta[1].'" AND YEAR(fecha) ="'.$year_Consulta.'" ';
