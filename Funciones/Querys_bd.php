...
/*Consulta por mes de cuenta de gastos iva*/$query_CTAGASTOS_IMP='SELECT * FROM cuentas_gastos WHERE MONTH(fecha) BETWEEN "'.$fechaIN_Consulta[1].'" AND "'.$fechaFN_Consulta[1].'" AND YEAR(fecha) ="'.$year_Consulta.'" AND folio_fiscal!="" AND auxiliar LIKE "2180-001-%"';
